	...
	return (
		<main className="relative min-h-screen overflow-hidden bg-black">
			...
			<div className="relative z-10">
				{/* Hero Section */}
				<section className="container mx-auto px-4 py-16 min-h-screen flex flex-col justify-center">
					<div className="flex flex-col items-center text-center space-y-8">
						...
						>
							...
							<FloatingPanel
								...
								icon={<Brain className="size-6 text-naija-green-400" />}
							...
							<FloatingPanel
								...
								icon={<TrendingUp className="size-6 text-naija-green-300" />}
						...
						<motion.div
							...
							className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl mx-auto mt-20"
						>
							<FeatureCard
