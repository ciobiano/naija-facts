...
export default function ModernHero() {
	...
	return (
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-black/95 to-naija-green-950/20">
			{/* Noise texture */}
			<div
			...
			<motion.div
				className="absolute top-1/4 left-1/4 w-64 h-64 bg-naija-green-500/8 rounded-full blur-3xl"
				animate={{
					scale: [1, 1.3, 1],
					opacity: [0.3, 0.6, 0.3],
				}}
			...
			/>
			<motion.div
				className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-cultural-gold/8 rounded-full blur-3xl"
				animate={{
					scale: [1.3, 1, 1.3],
					opacity: [0.2, 0.5, 0.2],
				}}
			...
			<div className="rounded-2xl backdrop-blur-2xl bg-white/10 border border-white/20 p-6 shadow-2xl group cursor-pointer hover:bg-white/15 transition-all duration-300">
				<div className="space-y-4">
					<div className="flex items-center justify-between">
						<div className="p-2 rounded-lg bg-white/10 text-naija-green-400">
							{icon}
						</div>
