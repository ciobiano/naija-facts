...
export default withAuth(
	function middleware(req: NextRequest & { nextauth: { token: JWT | null } }) {
		...
		const cspHeader = [
			...
			"img-src 'self' blob: data: https: https://utfs.io https://*.ingest.uploadthing.com",
			"font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net",
			"connect-src 'self' https://*.uploadthing.com https://*.ingest.uploadthing.com https://api.uploadthing.com",
			"object-src 'none'",
			"base-uri 'self'",
			"form-action 'self'",
